...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PBInfiniteHorizontalScroll.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/PBInfiniteHorizontalScroll'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Sungmin Kim' => 'purpleblues568@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/PBInfiniteHorizontalScroll.git', :tag => s.version.to_s }
